...
course = Course_T(courseID='EEE131', courseName="Electrical Circuit I", numOfCredits=4, program_id=3, courseType="Foundation")
course.save()
...
def updatedatabase(d, sem, y):
    df = pd.read_excel("EEE131.xlsx", sheet_name="Marks")
