...
course = Course_T(courseID='GSG402', courseName="Database Management", numOfCredits=3, program_id=6,
                  courseType="Core")
course.save()
...
faculties = []
faculties.append(Faculty_T.objects.get(pk=4604))
faculties.append(Faculty_T.objects.get(pk=4605))
faculties.append(Faculty_T.objects.get(pk=4606))
...
def updatedatabase(d, sem):
    df = pd.read_excel("GSG402.xlsx", sheet_name="Marks")
