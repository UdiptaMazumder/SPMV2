...
course = Course_T(courseID='EEE211', courseName="Electrical Circuit II", numOfCredits=4, program_id=3, courseType="Core")
course.save()
...
def updatedatabase(d, sem, y):
    df = pd.read_excel("EEE211.xlsx", sheet_name="Marks")
