...
course = Course_T(courseID='EEE321', courseName="Digital Signal Processing", numOfCredits=4, program_id=3, courseType="Core")
course.save()
...
def updatedatabase(d, sem, y):
    df = pd.read_excel("EEE321.xlsx", sheet_name="Marks")
