...
course = Course_T(courseID='MIS441', courseName="Accounting Information Systems", numOfCredits=3, program_id=4,
                  courseType="Core")
course.save()
...
faculties = []
faculties.append(Faculty_T.objects.get(pk=4404))
faculties.append(Faculty_T.objects.get(pk=4405))
faculties.append(Faculty_T.objects.get(pk=4406))
...
def updatedatabase(d, sem):
    df = pd.read_excel("MIS441.xlsx", sheet_name="Marks")
