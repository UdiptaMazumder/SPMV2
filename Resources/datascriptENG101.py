...
course = Course_T(courseID='ENG101', courseName="Database Management", numOfCredits=3, program_id=5,
                  courseType="Core")
course.save()
...
faculties = []
faculties.append(Faculty_T.objects.get(pk=4504))
faculties.append(Faculty_T.objects.get(pk=4505))
faculties.append(Faculty_T.objects.get(pk=4506))
...
def updatedatabase(d, sem):
    df = pd.read_excel("ENG101.xlsx", sheet_name="Marks")
