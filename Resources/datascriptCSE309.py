...
course = Course_T(courseID='CSE309', courseName="Web Applications and Internet", numOfCredits=3, program_id=1, courseType="Core")
course.save()
...
colist.append(CO_T(coNum="CO3", course=course, plo=plolist[5]))
...
faculties = []
faculties.append(Faculty_T.objects.get(pk=4101))
faculties.append(Faculty_T.objects.get(pk=4102))
faculties.append(Faculty_T.objects.get(pk=4103))
...
def updatedatabase(d, sem, y):
    df = pd.read_excel("CSE309.xlsx", sheet_name="Marks")
