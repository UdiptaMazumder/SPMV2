...
course = Course_T(courseID='CSE307', courseName="System Analysis and Design", numOfCredits=3, program_id=1, courseType="Core")
course.save()
...
colist.append(CO_T(coNum="CO4", course=course, plo=plolist[5]))
...
def updatedatabase(d, sem, y):
    df = pd.read_excel("CSE307.xlsx", sheet_name="Marks")
