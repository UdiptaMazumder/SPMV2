...
course = Course_T(courseID=data[3][2], courseName="Discrete Mathematics", numOfCredits=3, program_id=1, courseType="Core")
course.save()
...
faculties.append(Faculty_T.objects.get(pk=4260))
faculties.append(Faculty_T.objects.get(pk=4261))
