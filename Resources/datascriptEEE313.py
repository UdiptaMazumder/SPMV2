...
course = Course_T(courseID='EEE313', courseName="Electromagnetic Fields and Waves", numOfCredits=3, program_id=3, courseType="Core")
course.save()
...
faculties = []
faculties.append(Faculty_T.objects.get(pk=4307))
faculties.append(Faculty_T.objects.get(pk=4308))
faculties.append(Faculty_T.objects.get(pk=4309))
...
def updatedatabase(d, sem, y):
    df = pd.read_excel("EEE313.xlsx", sheet_name="Marks")
