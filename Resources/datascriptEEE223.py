...
course = Course_T(courseID='EEE223', courseName="Mechanical Engineering Fundamentals", numOfCredits=4, program_id=3, courseType="Core")
course.save()
...
def updatedatabase(d, sem, y):
    df = pd.read_excel("EEE223.xlsx", sheet_name="Marks")
