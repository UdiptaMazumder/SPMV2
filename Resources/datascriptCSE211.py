...
course = Course_T(courseID='CSE211', courseName="Algorithms", numOfCredits=4, program_id=1, courseType="Core")
course.save()
...
colist.append(CO_T(coNum="CO1", course=course, plo=plolist[11]))
...
def updatedatabase(d, sem, y):
    df = pd.read_excel("CSE211.xlsx", sheet_name="Marks")
