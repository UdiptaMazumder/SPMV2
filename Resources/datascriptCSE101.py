...
course = Course_T(courseID='CSE101', courseName="Introduction to Computer Programming", numOfCredits=4, program_id=1, courseType="Foundation")
course.save()
...
def updatedatabase(d, sem, y):
    df = pd.read_excel("CSE101.xlsx", sheet_name="Marks")
