...
course = Course_T(courseID='EEE311', courseName="Communication Engineering I", numOfCredits=4, program_id=3, courseType="Core")
course.save()
...
def updatedatabase(d, sem, y):
    df = pd.read_excel("EEE311.xlsx", sheet_name="Marks")
