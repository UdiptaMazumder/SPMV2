...
df = pd.read_excel("CSE214.xlsx", sheet_name="Marks")

data = df.values.tolist()

course = Course_T(courseID=data[3][2], courseName="Computer Organization and Architecture", numOfCredits=3, program_id=1, courseType="Core")
course.save()
...
colist.append(CO_T(coNum="CO3", course=course, plo=plolist[4]))
colist.append(CO_T(coNum="CO4", course=course, plo=plolist[9]))
