...
course = Course_T(courseID='GSG101', courseName="Database Management", numOfCredits=3, program_id=6,
                  courseType="Core")
course.save()
...
faculties = []
faculties.append(Faculty_T.objects.get(pk=4601))
faculties.append(Faculty_T.objects.get(pk=4602))
faculties.append(Faculty_T.objects.get(pk=4603))
...
def updatedatabase(d, sem):
    df = pd.read_excel("GSG101.xlsx", sheet_name="Marks")
