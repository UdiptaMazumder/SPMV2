...
df = pd.read_excel("CSE213.xlsx", sheet_name="Marks")

data = df.values.tolist()

course = Course_T(courseID=data[3][2], courseName="Object-Oriented Programming", numOfCredits=4, program_id=1, courseType="Core")
course.save()
...
colist.append(CO_T(coNum="CO1", course=course, plo=plolist[7]))
colist.append(CO_T(coNum="CO2", course=course, plo=plolist[8]))
