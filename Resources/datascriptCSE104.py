...
course = Course_T(courseID='CSE104', courseName="Electrical Circuit Analysis", numOfCredits=4, program_id=1, courseType="Foundation")
course.save()
...
def updatedatabase(d, sem, y):
    df = pd.read_excel("CSE104.xlsx", sheet_name="Marks")
