...
course = Course_T(courseID='EEE132', courseName="Introduction to Materials and Chemistry", numOfCredits=4, program_id=3, courseType="Foundation")
course.save()
...
faculties = []
faculties.append(Faculty_T.objects.get(pk=4301))
faculties.append(Faculty_T.objects.get(pk=4302))
faculties.append(Faculty_T.objects.get(pk=4303))
...
def updatedatabase(d, sem, y):
    df = pd.read_excel("EEE132.xlsx", sheet_name="Marks")
