...
##################### IMPUT form MODEL creation #################################

class dataentry2AddingnewCourseinformation_T (models.Model):
     courseID = models.CharField(max_length=7, primary_key=True)
     section = models.ForeignKey(Section_T, on_delete=models.CASCADE)
     year = models.IntegerField()
     semester = models.CharField(max_length=15)
...
class dataentry2AddingAssessmentdata_T (models.Model):
    assessmentName = models.CharField(max_length=30,primary_key=True)

    def __str__(self):
        return str(self.assessmentName)


class dataentry2mappingPloToCo_T (models.Model):
    courseID = models.CharField(max_length=7, primary_key=True)
    coNum = models.CharField(max_length=4)    
...
class dataentry2AddingnEvalautionData_T (models.Model):
    courseID = models.CharField(max_length=7, primary_key=True)   
    section = models.ForeignKey(Section_T, on_delete=models.CASCADE)
    semester = models.CharField(max_length=15)
    year = models.IntegerField()
